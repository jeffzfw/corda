...
class MockNetwork(private val networkSendManuallyPumped: Boolean = false,
    ...
    open class MockNode(config: NodeConfiguration,
        ...
        override fun makeMessagingService(): MessagingServiceInternal {
            ...
            return mockNet.messagingNetwork.createNodeWithID(!mockNet.threadPerNode, id, serverThread, makeServiceEntries(), configuration.myLegalName.commonName, database).start().getOrThrow()
        }
